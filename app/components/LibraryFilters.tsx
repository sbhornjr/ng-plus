        ...
        <div>
            <div className="flex gap-4 items-center justify-center w-full mb-6">
                <button
                    ...
                    className={`text-xl px-2 py-1 rounded-lg transition-all duration-200 ${selectedStatus == "" ? "border border-[#00d4aa] text-[#00d4aa]" : "hover:border hover:border-[#00d4aa] hover:text-[#00d4aa]"}`}
                >
                    All
                </button>
                <button
                    onClick={() => handleStatus("completed")}
                    className={`text-xl px-2 py-1 rounded-lg transition-all duration-200 ${selectedStatus == "completed" ? "border border-[#00d4aa] text-[#00d4aa]" : "hover:border hover:border-[#00d4aa] hover:text-[#00d4aa]"}`}
                >
                    Completed
                </button>
                <button
                    onClick={() => handleStatus("playing")}
                    className={`text-xl px-2 py-1 rounded-lg transition-all duration-200 ${selectedStatus == "playing" ? "border border-[#00d4aa] text-[#00d4aa]" : "hover:border hover:border-[#00d4aa] hover:text-[#00d4aa]"}`}
                >
                    Playing
                </button>
                <button
                    onClick={() => handleStatus("backlog")}
                    className={`text-xl px-2 py-1 rounded-lg transition-all duration-200 ${selectedStatus == "backlog" ? "border border-[#00d4aa] text-[#00d4aa]" : "hover:border hover:border-[#00d4aa] hover:text-[#00d4aa]"}`}
                >
                    Backlog
                </button>
                <button
                    onClick={() => handleStatus("abandoned")}
                    className={`text-xl px-2 py-1 rounded-lg transition-all duration-200 ${selectedStatus == "abandoned" ? "border border-[#00d4aa] text-[#00d4aa]" : "hover:border hover:border-[#00d4aa] hover:text-[#00d4aa]"}`}
                >
                    Abandoned
                </button>
            </div>
